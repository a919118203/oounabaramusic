...
public class AllMyPlayListAdapter extends RecyclerView.Adapter<AllMyPlayListAdapter.ViewHolder> {

    private Activity activity;
    private List<PlayList> dataList;
    private int userId;

    public AllMyPlayListAdapter(Activity activity){
    ...
    static class MyHandler extends Handler{
        ...
        AllMyPlayListAdapter adapter;
        MyHandler(AllMyPlayListAdapter adapter){
